...
var init_web = __esm({ "node_modules/@google/genai/dist/web/index.mjs"() {
	...
	defaultLiveSendClientContentParamerters = { turnComplete: true };
	Session = class {
...
var require_use_ai = __commonJS({ "src/use-ai.js"() {
	init_web();
